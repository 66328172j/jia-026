...
/**
 * 有限空间气体分级规则对象 t_utun_gas_rule
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_utun_gas_rule")
@ApiModel(value = "TUtunGasRule", description = "有限空间气体分级规则")
public class TUtunGasRule implements Serializable {
    ...
    /** 安全档上限 */
    @TableField("th1_max")
    @ApiModelProperty(value = "安全档上限")
    private BigDecimal th1Max;

    /** 通风档上限 */
    @TableField("th2_max")
    @ApiModelProperty(value = "通风档上限")
    private BigDecimal th2Max;

    /** 禁入档上限 */
    @TableField("th3_max")
    @ApiModelProperty(value = "禁入档上限")
