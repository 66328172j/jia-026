...
/**
 * 有限空间气体分级规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITUtunGasRuleService {

    /** 按主键查询规则 */
    TUtunGasRule selectTUtunGasRuleById(Long id);
    ...
    List<TUtunGasRule> listAvailable(Date at);
